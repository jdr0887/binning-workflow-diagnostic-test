...
import org.renci.canvas.binning.diagnostic.test.commons.UpdateDiagnosticBinsCallable;
...
@Command(scope = "diagnostic-test", name = "update-diagnostic-bins", description = "Update Diagnostic Bins")
@Service
